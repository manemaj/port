...
const projectData = {
    ...
    carscan: {
        title: "CarScan AI - Mobile Application",
        images: [
            { src: "carscan video.mp4", alt: "CarScan AI Demo Video", isVideo: true }
        ],
        description: `
            <h3>What I Built</h3>
            <p>Developed and published CarScan AI, a mobile app that uses artificial intelligence to recognize and analyze vehicles. Built it from scratch and got it on the App Store, which was pretty cool.</p>
            
            <h3>The Challenge</h3>
            <p>Learning mobile development and figuring out how to integrate AI into an app was tough. Had to deal with a lot of technical challenges around making the AI recognition actually work smoothly on phones.</p>
            
            <h3>What I Learned</h3>
            <ul>
                <li>Mobile app development and UI/UX design</li>
                <li>How to integrate AI/ML models into consumer apps</li>
                <li>App Store deployment process and requirements</li>
                <li>Persistence—debugging and fixing issues until it actually worked</li>
            </ul>
            
            <h3>Results</h3>
            <p>Successfully published on the App Store. It's a working product that people can actually download and use. Taught me a lot about taking a project from idea to finished product.</p>
        `,
        tech: ["Mobile Development", "AI Integration", "App Store", "iOS Development", "Product Design", "User Interface"]
    }
};
...
function openProjectModal(projectId) {
    ...
    if (firstMedia.isVideo) {
        ...
        video.autoplay = true;
        video.loop = true;
        // Use contain for vertical videos (like phone recordings)
        const objectFit = firstMedia.src.includes('carscan') ? 'contain' : 'cover';
        video.style.cssText = `width: 100%; height: 100%; object-fit: ${objectFit}; background-color: #1a1a2e;`;
...
function switchModalImage(index) {
    ...
    setTimeout(() => {
        ...
        if (currentMedia.isVideo) {
            ...
            video.loop = true;
            // Use contain for vertical videos (like phone recordings)
            const objectFit = currentMedia.src.includes('carscan') ? 'contain' : 'cover';
            video.style.cssText = `width: 100%; height: 100%; object-fit: ${objectFit}; background-color: #1a1a2e;`;
